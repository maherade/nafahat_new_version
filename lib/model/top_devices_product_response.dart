class ListTopDevicesProductResponse {
  List<Data>? data;
  Headers? headers;
  int? status;

  ListTopDevicesProductResponse({this.data, this.headers, this.status});

  ListTopDevicesProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
