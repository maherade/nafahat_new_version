...
class ListTopPerfumeProductResponse {
  List<Data>? data;
  Headers? headers;
  int? status;

  ListTopPerfumeProductResponse({this.data, this.headers, this.status});

  ListTopPerfumeProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
