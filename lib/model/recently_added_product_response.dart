class ListRecentlyAddedProductResponse {
  List<Data>? data;
  Headers? headers;
  int? status;

  ListRecentlyAddedProductResponse({this.data, this.headers, this.status});

  ListRecentlyAddedProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
