class ListTopNailsProductResponse {
  List<Data>? data;
  Headers? headers;
  int? status;

  ListTopNailsProductResponse({this.data, this.headers, this.status});

  ListTopNailsProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
