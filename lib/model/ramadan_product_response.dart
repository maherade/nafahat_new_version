class ListRamadanProductResponse {
  List<Data>? data;
  Headers? headers;
  int? status;

  ListRamadanProductResponse({this.data, this.headers, this.status});

  ListRamadanProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
