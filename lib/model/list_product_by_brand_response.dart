class ListProductByBrandResponse {
  List<Data>? data;
  Headers? headers;
  int? status;

  ListProductByBrandResponse({this.data, this.headers, this.status});

  ListProductByBrandResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
