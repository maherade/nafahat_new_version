class ListTopMakeupProductResponse {
  List<Data>? data;
  Headers? headers;
  int? status;

  ListTopMakeupProductResponse({this.data, this.headers, this.status});

  ListTopMakeupProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
