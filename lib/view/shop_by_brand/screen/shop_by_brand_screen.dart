                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [
                          SizedBox(
                            width:140.w,
                            child: CustomText(
                            'تسوق من براند ${widget.brandName}',
                      ...
                      productController.getProductByBrandData!.value.headers?.xWPTotalPages == null ? LoadingPaggination() : NumberPaginator(
                        // controller: _controller, cause exception
                        initialPage: currentPage??0,
                        numberPages: productController.getProductByBrandData!.value.headers!.xWPTotalPages!,
                        ...
                        onPageChange: (int index) {
                          ...
                          ProductApies.productApies.getProductByBrand(
                              brand: widget.brandId.toString() , pageNumber: (index+1).toString(),
                              order: order,
                              orderBy: orderBy
                          );
                        },
