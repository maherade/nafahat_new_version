                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ShowAllBrandScreen(),
                            ));
                      },
                      child: Container(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      ...
                                      ProductApies.productApies
                                        ...
                                        category: category[index].id.toString(),
                                        onSale: true,
                                      );
                                    },
                                    child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        famousProduct == null
                            ...
                            : SizedBox(
                                height: deviceSize.height > 500 ? 300.h : 200.h,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  ConfidentPoints(
                    ...
                    description:
                        "تقدم خدمة الدفع عند الاستلام لتوفير راحة",
                    restDescription: 'إضافية للعملاء.',
                  ...
                  ConfidentPoints(
                    ...
                    description:
                        "يتم استخدام أحدث تقنيات التشفير لضمان حماية",
                    restDescription: 'بيانات الدفع الشخصية.',
                    title: 'دفع آمن',
                  ),
                  SizedBox( height: 10.h,),
                  ...
                  ConfidentPoints(
                    ...
                    description:
                        "نفتخر بتقديم منتجات أصلية بنسبة 100% لضمان",
                    restDescription: ' جودة وكفاءة عالية.',
                  ...
                  ConfidentPoints(
                    ...
                    description: "في حال عدم رضا العميل عن المنتج، يمكنهم",
                    restDescription: ' إعادته بسهولة دون أي تكلفة إضافية.',
                    title: 'استرجاع مجاني',
                  ),
                ],
                ),
