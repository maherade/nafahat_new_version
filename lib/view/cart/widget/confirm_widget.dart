      ...
      builder: (appController) {
        return GetBuilder<CartController>(
          ...
          builder: (cartController) {
            return Obx(
              () {
                var shippingMethod = orderController
                    .getShippingMethodsData!.value.listShippingMethodsResponse;
                var countries = orderController
                    .getCountriesData!.value.listCountriesResponse;
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      appController.shippingGroupValue ==
                                                                  index &&
                                                              appController
                                                                      .selectedAddress ==
                                                                  'redbox_pickup_delivery' &&
                          ...
                          payment == null
                              ...
                              : GridView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    payment[index].id == 'paytabs_applepay'
                                        ? image = 'selectApplePay.png'
                                    ...
                                    // debugPrint("id: "+payment[index].id.toString());
                                    // debugPrint("name: "+payment[index].title.toString());
                                    return InkWell(
                                      onTap: () {
                                        appController
                                        ...
                                        appController
                                            .updateSelectedPaymentMethodsTitle(
                                          payment[index].title!,
                                        );
                                      },
                          ...
                          if (appController.selectedCountries != null &&
                            ...
                            if (appController.selectedCountries?.code == 'SA') {
                              ...
                              CustomDialog.customDialog
                                  .showConfirmSendMessageDialog(
                                onTap: () {
                                  debugPrint(currentPin.toString());
                                  Get.back();
                            ...
                            if (!emailRegex.hasMatch(
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content:
                                      Text('email_address_not_valid_value'.tr),
                                ),
                              );
                            } else {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'please_fill_all_information_value'.tr,
                                  ),
                                ),
                              );
                            }
