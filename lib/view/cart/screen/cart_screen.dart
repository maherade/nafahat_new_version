                                                  ...
                                                  itemBuilder: (context, index) {
                                                    return CustomCartProductItem(
                                                      ...
                                                      total: (cartController.items.values.toList()[index].quantity! *
                                                          ...
                                                          .toStringAsFixed(2),
                                                      onTapTrash: () {
                                                        cartController.removeItem(cartController.items.values.toList()[index].id!);
                                                      },
                                                      onTapIncrease: () {
                                                        cartController.addItem(pdtid: cartController.items.values.toList()[index].id.toString());
                                                      },
                                                      onTapDecrease: () {
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          index==2?CustomText('from_the_market_value'.tr,fontSize: 12.sp,):SizedBox.shrink(),
                                                                          shippingGroupValue == index &&
                                                                              selectedAddress ==
                                                                                  'redbox_pickup_delivery' &&
                                                  ...
                                                  children: [
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              CustomText(
                                                                selectedAddress == 'redbox_pickup_delivery' ? (cartController.totalAfterDiscount + 17).toStringAsFixed(2) : selectedAddress == 'naqel_shipping' ? (cartController.totalAfterDiscount + 30).toStringAsFixed(2) : (cartController.totalAfterDiscount + 0).toStringAsFixed(2),
                                                                fontSize: 14.sp,
                                                                fontWeight: FontWeight.normal,
                                                              ),
                                                            ],
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        orderController.getCouponData?.value.status!='publish'?Expanded(
                                                          child: CustomButton(
                                                            onTap: () {
                                                              OrderApies.orderApies
                                                                  ...
                                                                  .then((value) {
                                                                    cartController.subtractFromPrice(
                                                                      double.parse(orderController.getCouponData!.value.amount!)
                                                                    );
                                                              });
                                                            },
                                                            height: 50.h,
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        SizedBox(width: 15.w,),
                                                        point?.points == null ? SizedBox() :Expanded(
                                                          child: CustomButton(
                                                            onTap: () {
                                                             ...
                                                             if(int.parse(point!.points.toString())>=points&&points>0){
                                                               OrderApies.orderApies.decreasePoints(
                                                               ...
                                                               SVProgressHUD.showError(status: 'you_dont_have_enough_point_value'.tr);
                                                             }
                                              ...
                                              Padding(
                                                ...
                                                child: CustomButton(
                                                  onTap: () async {
                                                    ...
                                                    //         cartController.totalAfterDiscount.toString(), 'SAR', //SAR //EGP
                                                    //         callbackUrl: '',
                                                    //         lang: 'EN',
