  ...
  dropDown(String value) {
    switch (value) {
      ...
      case 'ترتيب حسب معدل التقييم':
        ProductApies.productApies.getCareProductData(
            pageNumber: '1', order: 'asc', orderBy: 'rating');
        setState(() {
          order = 'asc';
          orderBy = 'rating';
          currentPage = 0;
      ...
      case 'ترتيب حسب الأحدث':
        ProductApies.productApies.getCareProductData(
            pageNumber: '1', order: 'asc',  orderBy: 'date');
        setState(() {
          order = 'asc';
          orderBy = 'date';
          currentPage = 0;
      ...
      case 'ترتيب حسب الأدنى سعرا للأعلى':
        ProductApies.productApies.getCareProductData(
            pageNumber: '1', order: 'desc', orderBy: 'price');
        setState(() {
          order = 'desc';
          orderBy = 'price';
          currentPage = 0;
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      productController
                                  .getCareProductDataData!.value.headers?.xWPTotalPages ==
                              null
                          ? LoadingPaggination()
                          : product!.isEmpty
                              ? SizedBox()
